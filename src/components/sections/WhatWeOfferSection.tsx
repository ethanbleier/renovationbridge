    ...
    <section id="what-we-offer-section" className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="container-custom px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          {/* Connections */}
          <div className="bg-cream rounded-lg p-5 sm:p-8 shadow-lg overflow-hidden transform transition-all hover:scale-105 flex flex-col h-full">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary text-white rounded-full flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-8 sm:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Connections</h3>
            <p className="text-gray flex-grow text-sm sm:text-base">
          ...
          <div className="bg-cream rounded-lg p-5 sm:p-8 shadow-lg overflow-hidden transform transition-all hover:scale-105 flex flex-col h-full">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Professional Advice</h3>
            <p className="text-gray flex-grow text-sm sm:text-base">
          ...
          <div className="bg-cream rounded-lg p-5 sm:p-8 shadow-lg overflow-hidden transform transition-all hover:scale-105 flex flex-col h-full">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Negotiations</h3>
            <p className="text-gray flex-grow text-sm sm:text-base">
          ...
          <div className="bg-cream rounded-lg p-5 sm:p-8 shadow-lg overflow-hidden transform transition-all hover:scale-105 flex flex-col h-full">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">A Partner</h3>
            <p className="text-gray flex-grow text-sm sm:text-base">
