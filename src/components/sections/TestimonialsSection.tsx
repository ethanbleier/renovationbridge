      ...
      <div className="container-custom">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-visible transform transition-all hover:scale-105">
              ...
              <div className="p-8 pt-14 relative">
                <div className="absolute left-1/2 transform -translate-x-1/2 -top-10">
                  <div className="w-20 h-20 rounded-full flex items-center justify-center border-4 border-white shadow-md overflow-hidden">
                    <Image 
                ...
                <p className="text-gray italic mb-6 text-center">
                ...
                <div className="text-center">
                  <h4 className="font-bold text-lg">Kim C</h4>
                  <p className="text-gray text-sm">Livermore</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-visible transform transition-all hover:scale-105">
              <div className="bg-primary h-3"></div>
              <div className="p-8 pt-14 relative flex flex-col h-full">
                <div className="absolute left-1/2 transform -translate-x-1/2 -top-10">
                  <div className="w-20 h-20 rounded-full flex items-center justify-center border-4 border-white shadow-md overflow-hidden">
                    <Image 
                ...
                <p className="text-gray italic mb-6 text-center flex-grow">
                ...
                <div className="text-center mt-auto">
                  <h4 className="font-bold text-lg">Amy C</h4>
                  <p className="text-gray text-sm">Alamo</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-visible transform transition-all hover:scale-105">
              ...
              <div className="p-8 pt-14 relative flex flex-col h-full">
                ...
                <div className="text-center mt-auto">
                  <h4 className="font-bold text-lg">Jonah K</h4>
                  <p className="text-gray text-sm">Walnut Creek</p>
                </div>
              </div>
            </div>
          </div>
