...
// Removed imageFadeIn
// Removed afterImageCycle

// Add responsive animation settings
// Removed useResponsiveAnimations hook
...
export default function SavePage() {
  ...
  // Removed isMobile and useResponsiveAnimations
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24">
        ...
        <div className="py-16 sm:py-20 md:py-24">
          ...
          <div className="relative w-full max-w-5xl mx-auto overflow-hidden h-[70px] sm:h-[100px]">
            {/* Gradient fade on left edge - adjust from-white to from-cream */}
            ...
            <div className="w-full h-full flex items-center relative">
              ...
              >
                {trustLogos.map((logo) => (
                  <div
                    key={logo.id} // Use logo.id from trustLogos
                    className="inline-flex items-center justify-center w-[80px] sm:w-[120px] h-[50px] sm:h-[80px]"
                  >
                    <Image
                      src={logo.logo} // Use logo.logo
                      alt={logo.name}  // Use logo.name
                      width={120}
                      height={80}
                ...
                {trustLogos.map((logo) => (
                  <div
                    key={`${logo.id}-duplicate`} // Use logo.id
                    className="inline-flex items-center justify-center w-[80px] sm:w-[120px] h-[50px] sm:h-[80px]"
                  >
                    <Image
                      src={logo.logo} // Use logo.logo
            ...
            {/* Gradient fade on right edge - adjust from-white to from-cream */}
