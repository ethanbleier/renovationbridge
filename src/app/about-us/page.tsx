    ...
    <div className="relative bg-black text-white min-h-screen">
      ...
      <div className="py-10 sm:py-16 px-5 sm:px-6 lg:px-12 xl:px-16">
        <div className="max-w-[1920px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-24 sm:mb-32">
            {/* Onn Matalon */}
            <div className="border-t border-gray-700 pt-8">
              <div className="relative h-full flex flex-col">
                <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 md:gap-12">
                  <div className="flex-shrink-0 mx-auto sm:mx-0">
                    <div className="relative w-[180px] h-[240px] sm:w-[300px] sm:h-[400px] md:w-[400px] md:h-[500px]">
                      <Image 
                        src="/images/about-us/onn.jpg" 
                        alt="Onn Matalon" 
                        fill 
                        className="object-cover" 
                        sizes="(max-width: 640px) 180px, (max-width: 768px) 300px, 400px"
                      />
                    </div>
                  </div>
                  <div className="flex-1 overflow-hidden">
                    ...
                    <div className="text-gray-200 leading-relaxed">
                      ...
                      <p className="text-sm sm:text-base mt-4">Our vision is to expand across the country and become the trusted platform homeowners turn to when they want to renovate with confidence.</p>
                    </div>
                  </div>
                </div>
                
                <div className="text-gray-200 space-y-4 leading-relaxed mt-8 sm:mt-16 flex-1">
          ...
          <div className="mt-24 sm:mt-32 mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 max-w-[1600px] mx-auto">
              ...
              <div className="flex flex-col justify-center">
                <h3 className="text-xl font-semibold mb-4">Featured on Local News</h3>
                <p className="text-gray-200 leading-relaxed">
                  Renovation Bridge has been featured on multiple local news channels, showcasing our innovative approach to home renovations. Watch our latest feature to learn more about how we're transforming the home improvement industry.
                </p>
