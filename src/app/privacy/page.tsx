...
export const metadata = {
  title: 'Privacy Policy | Renovation Bridge',
  description: 'Privacy Policy for Renovation Bridge - Learn how we collect, use, and protect your personal information.',
};
...
const PrivacyPolicy = () => {
  return (
    <div className="container-custom py-16">
      ...
      <p className="text-gray-600 mb-6">Last updated: August 15, 2024</p>
      ...
      <div className="prose max-w-none">
        ...
        <ul className="list-disc pl-6 space-y-2 mt-4">
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Matalon, 2212 TICE VALLEY BLVD.</li>
          ...
          <li><strong>Website</strong> refers to Renovation Bridge, accessible from www.renovationbridge.com</li>
        ...
        <ul className="list-disc pl-6 space-y-2 mt-4">
          <li>By email: onn@renovationbridge.com</li>
        </ul>
      </div>
    </div>
  );
