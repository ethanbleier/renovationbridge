    ...
    <main className="min-h-screen relative">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            <p className="text-lg mb-6">
              We come from a real estate background and understand how much you care about your clients. That's why Renovation Bridge is here to provide them with the best possible renovation experience. We personally guide each homeowner through every step of the process—from finding the right contractor to negotiating the best deals—ensuring a smooth and stress-free renovation.
            </p>
            <p className="text-lg mb-6">
              As a gesture of our appreciation, we offer a substantial referral bonus for each project you refer to us.
            </p>
      ...
      <section className="bg-slate-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-10 md:mb-16">Refer Now!</h2>
          
          <div className="md:flex md:gap-10 lg:gap-16 items-start">
            {/* Left Column: Text and Social Icons */}
            <div className="md:w-1/3 text-center md:text-left mb-12 md:mb-0">
              <p className="text-lg mb-8">
                Refer your client to us, and we will take care of the outreach. Simply complete the form, and we will manage the process from there. We are dedicated to ensuring a seamless experience for both you and your client.
              </p>
              <p className="text-lg mb-8">
                We value your partnership and look forward to helping your clients achieve their renovation goals.
              </p>
              {/* Social Media Icons */}
