        ...
        <div className="container-custom">
          ...
          >
            ...
            <motion.div 
              ...
              className="flex flex-col md:flex-row items-center mb-20 md:mb-32"
            >
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
                <div className="relative">
                  <div className="bg-lavender/20 rounded-lg overflow-hidden aspect-video shadow-md hover:shadow-lg transition-shadow duration-300">
                    <Image
                  ...
                  <div className="absolute -bottom-5 -right-5 bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold shadow-lg">1</div>
                </div>
              </div>
            ...
            <motion.div 
              variants={itemVariants}
              className="flex flex-col md:flex-row-reverse items-center mb-20 md:mb-32"
            >
              <div className="md:w-1/2 mb-8 md:mb-0 md:pl-12">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-5 -left-5 bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold shadow-lg">2</div>
                </div>
              </div>
              <div className="md:w-1/2">
            ...
            >
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-5 -right-5 bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold shadow-lg">3</div>
                </div>
              </div>
              <div className="md:w-1/2">
            ...
            >
              <div className="md:w-1/2 mb-8 md:mb-0 md:pl-12">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-5 -left-5 bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold shadow-lg">4</div>
                </div>
              </div>
              <div className="md:w-1/2">
            ...
            >
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-5 -right-5 bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold shadow-lg">5</div>
                </div>
              </div>
              <div className="md:w-1/2">
      ...
      <section className="py-12 bg-primary text-white">
        <div className="container-custom">
          ...
          >
            ...
            <Link 
              href="/get-started" 
              className="bg-white text-primary font-medium px-8 py-3 rounded-full hover:bg-gray-100 transition-colors inline-block hover:shadow-lg transform hover:scale-105 transition-all duration-300"
            >
              Start Your Project
            </Link>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 mb-4">Everything you need to know about our service and renovation process</p>
              <Link 
                href="/resources/faq" 
                className="inline-flex items-center text-primary font-medium hover:underline hover:text-primary-dark transition-colors"
              >
                View all FAQs
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mb-12 hover:shadow-md transition-shadow duration-300">
        ...
        <div className="container-custom">
          ...
          >
            ...
            >
              <Link 
                href="/get-started" 
                className="btn btn-primary text-lg px-8 py-3 shadow-lg hover:shadow-xl transition-shadow duration-300"
              >
                Get Started Now
              </Link>
            </motion.div>
